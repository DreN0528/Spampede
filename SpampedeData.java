...
class SpampedeData {
	...
	protected BoardCell getSouthNeighbor(BoardCell cell) {
		if (this.getCell(cell.getRow() + 1, cell.getColumn()).isWall()) {
			return null;
		}
		return this.getCell(cell.getRow() + 1, cell.getColumn());
	}
	...
	public BoardCell getNextCellInDir() {
		...
		case GOING_NORTH: return this.getNorthNeighbor();
		case GOING_SOUTH: return this.getSouthNeighbor();
		case GOING_EAST: return this.getEastNeighbor();
		case GOING_WEST: return this.getWestNeighbor();
		default: return null;
		}
	}
